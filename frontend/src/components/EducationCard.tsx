  ...
  return (
    <div
      className={`relative pl-8 border-l-2 transition-colors duration-300 py-4 group ${
        isDark
          ? "border-gray-800 hover:border-neon-purple"
    ...
    >
      ...
      <div
        className={`absolute -left-2.25 top-6 w-4 h-4 rounded-full border-2 transition-all duration-300 ${
          isDark
            ? "bg-cyber-black border-gray-600 group-hover:border-neon-purple group-hover:bg-neon-purple shadow-sm group-hover:shadow-md"
            : "bg-white border-gray-400 group-hover:border-purple-500 group-hover:bg-purple-500 shadow-sm group-hover:shadow-md"
        }`}
      ></div>
